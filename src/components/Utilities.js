      ...
      <Container>
        <Row className='pt-5 pb-3'>
          <div className="col-md-4" data-aos="fade-left">
            <FontAwesomeIcon icon={faBuilding} size='3x' color='#fff' />
          ...
          <div className="col-md-4" data-aos="fade-left">
            <FontAwesomeIcon icon={faTruckLoading} size='3x' color='#fff' />
            <h4 className='opacity-75 ms-2 text-white d-inline'>
              Service Provision
            </h4>
          ...
          <div className="col-md-4" data-aos="fade-left">
            <FontAwesomeIcon icon={faAmbulance} size='3x' color='#fff' />
            <h4 className='opacity-75 ms-2 text-white d-inline'>
              Emergency Response
            </h4>
          ...
          <div className="col-md-4" data-aos="fade-left">
            <FontAwesomeIcon icon={faUserFriends} size='3x' color='#fff' />
            <h4 className='opacity-75 ms-2 text-white d-inline'>
              Customer Service
            </h4>
          ...
          <div className="col-md-4" data-aos="fade-left">
            <FontAwesomeIcon icon={faRobot} size='3x' color='#fff' />
            <h4 className='opacity-75 ms-2 text-white d-inline'>
              Smart Technologies
            </h4>
            <p className='lead opacity-75 text-white d-'>
