                    ...
                    <div class="row flex-center pt-8 pt-lg-8 pb-lg-9 pb-xl-0 glassmorphism-bg-2">
                        <div class="col-md-11 col-lg-8 col-xl-12 pb-7 pb-xl-5 text-center text-xl-start">
                            <h1 class="text-white container fw-bold">
                                ADV: Your Strategic Partner in Talent Acquisition and Staffing Solutions
                            </h1>
                            <p class="lead container text-capitalize text-white opacity-75">
                                In today's competitive business landscape, finding the right talent is crucial for the success of any organization. ADV emerges as a beacon of excellence, offering comprehensive talent acquisition and staffing solutions tailored to meet the diverse needs of businesses across industries. With a commitment to excellence and a focus on building long-term partnerships, ADV stands ready to elevate your workforce to new heights.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <Container>
                <Row className="pt-3 ">
                    ...
                    <Col data-aos="fade-left" lg={6}>
                            ...
                            <div className="pt-3  text-white"><h2 className="text-center text-white">Staff Recruiting</h2>
                                <p className='lead container text-white opacity-75'>
                                    In an increasingly competitive marketplace, having the right talent can make all the difference between success and failure. With ADV as your trusted partner, you can gain access to top-tier talent, streamline your recruitment process, and build a high-performing workforce that propels your business forward. Discover the ADV advantage today and unlock the full potential of your workforce.
                                </p>
                            </div>
